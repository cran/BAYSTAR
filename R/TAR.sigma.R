`TAR.sigma` <-
function(reg,ay,thres,lagd,p1,p2,ph,v,lambda,lagp1,lagp2,constant=1,thresVar){
...
sigma<- 1/rgamma(1, shape, rate, scale = 1/rate)  ## Draw sigma^2 from an Inverse-Gamma distribution.
